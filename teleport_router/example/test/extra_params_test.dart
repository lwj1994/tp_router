...
void main() {
  testWidgets('MemoryDetailRoute uses default value when extra is missing',
    ...
    // Create a mock TeleportRouteData with empty extra
    final data = TeleportRouteData.fromPath('/memory-detail', extra: {
  ...
  testWidgets('MemoryDetailRoute uses provided value when extra is present',
    ...
    // Create a mock TeleportRouteData with custom extra
    final data = TeleportRouteData.fromPath('/memory-detail',
